...
li=[]
while True:
    x, y = map(int, input("\033[92menter the hour and minutes: ").split())
    if x == -1 or y == -1:
        break
    li.append([x,y])
...
print(f"\033[93myour hours is {hour}h and {minutes%60}m")
print(f"\033[91myour salary without Daman is : {salary:.2f}")
print(f"\033[94myour salary with Daman is : {salary-23:.2f}\033[0m ")